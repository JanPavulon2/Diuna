    ...
    public partial class ConfigManager
    {
        ...
        public void LoadConfig()
        {
            ...
            else
            {
                ...
                {
                    new SwitchConfig { Name = "Switch1", ButtonPin = 5, LedPin = 21, RelayPin = 26, IsOn = false },
                    new SwitchConfig { Name = "Switch2", ButtonPin = 11, LedPin = 20, RelayPin = 19, IsOn = false },
                    new SwitchConfig { Name = "Switch3", ButtonPin = 9, LedPin = 16, RelayPin = 13, IsOn = false },
                    new SwitchConfig { Name = "Switch4", ButtonPin = 10, LedPin = 12, RelayPin = 6, IsOn = false }
                };
                SaveConfig();
            }
        }
