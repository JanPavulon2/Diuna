...
namespace DiunaRelayControl
{
    ...
    public class SwitchControl 
    {
        ...
        public SwitchControl(string name, int buttonPin, int ledPin, int relayPin, bool isOn)
        {
        ...
        {
             Console.WriteLine($"Setting up button handler for {NameTag} on GPIO {ButtonPin}");
            ...
            _gpioController.RegisterCallbackForPinValueChangedEvent(ButtonPin, PinEventTypes.Falling, (sender, args) =>
            {
                ...
                {
                    Console.WriteLine($"Button pressed on {NameTag}");
                    Toggle();
